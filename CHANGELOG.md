...
## Fixes
- **Combo / Claude:** strip Claude Code `safeguards` so “Extra inputs are not permitted” can fall through; connect-timeout 502s skip the 502 retry ladder (was ~249s) and use a 15s headers wait + 10s soft cool instead of a 30s cascade lock
